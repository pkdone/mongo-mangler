pipeline = [
    {"$set": {
        ...
        "rank": fakeNumber(10),                                                                // Any number up to 15 digits in size
        ...
        "balance": fakeDecimalSignificantPlaces(8),                                            // Random decimal number to significant places
        ...
        "records": fakeListOfSubDocs(4, ["BLUE", "RED", "GREEN", "PURPLE", "ORANGE", "PINK"]), // Array of 5 random subdocuments
    }},
]
